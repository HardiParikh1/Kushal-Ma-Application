...
public class b4Screen extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.screen_b4);

        videoView = findViewById(R.id.videoView4);
        ingredientsList = findViewById(R.id.ingredientsList4);
        instructionsList = findViewById(R.id.instructionsList4);
        playAudioButton = findViewById(R.id.playAudioButton4);
        pauseAudioButton = findViewById(R.id.pauseAudioButton4);
        stopAudioButton = findViewById(R.id.stopAudioButton4);
        checkRecipeButton = findViewById(R.id.checkRecipeButton4);
        ...
        playAudioButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (audioPlayer == null) {
                    audioPlayer = MediaPlayer.create(b4Screen.this, R.raw.audio);
    ...
    protected void onResume() {
        ...
        Toast.makeText(b4Screen.this, "Timer is starting at " + (previousDuration / 1000) + " seconds", Toast.LENGTH_SHORT).show();
        Toast.makeText(b4Screen.this, "Video is starting at " + (savedVideoPosition / 1000) + " seconds", Toast.LENGTH_SHORT).show();
        Toast.makeText(b4Screen.this, "Audio is starting at " + (savedAudioPosition / 1000) + " seconds", Toast.LENGTH_SHORT).show();
    }
    ...
    protected void onPause() {
        ...
        Toast.makeText(b4Screen.this, "Timer is ending at " + (newDuration / 1000) + " seconds", Toast.LENGTH_SHORT).show();
        Toast.makeText(b4Screen.this, "Total time user spent on RecbScreen: " + (newDuration / 1000) + " seconds", Toast.LENGTH_SHORT).show();
        Toast.makeText(b4Screen.this, "Video is ending at " + (videoPosition / 1000) + " seconds", Toast.LENGTH_SHORT).show();
        if (audioPlayer != null) {
            Toast.makeText(b4Screen.this, "Audio is ending at " + (audioPosition / 1000) + " seconds", Toast.LENGTH_SHORT).show();
        }
    }
